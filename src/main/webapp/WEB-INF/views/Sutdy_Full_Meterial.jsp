...
<body id="page-top">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="Sutdy_Full_Meterial">전체학습자료실</a>
  ...
  <div align="left">
    <form name="form"   method="post" action="s_dat_all_s_list.asp">
                        ...
                        <table cellpadding="0" cellspacing="0" height="26" width="847">
                            <tr>
                                ...
                                <td width="78" height="26">
                                                                                        &nbsp;<input type="text" name="org_nm_s" size="7">
                                                        </td>
