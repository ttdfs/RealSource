...
<body id="page-top">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="Mng_Study_org_register.jsp">학습조직등록</a>  
                        <a class="collapse-item" href="Mng_Study_org">학습조직관리</a>                        
                        <a class="collapse-item active" href="Mng_Study_Meterial">학습자료열람관리</a>
  ...
  <div align="left">
    ...
    <table border="0" cellpadding="0" cellspacing="0" bordercolor="white" bordercolordark="white" bordercolorlight="#CCCCCC" bgcolor="white" height="69" width="865">
            ...
            <td width="133" height="37" class="tb_bottom"><b><font size="2" color="#3B608D">열람요청현황</font></b>        	</td>
    ...
    <table border="0" width="866" height="84" cellspacing="0">
        ...
        <tr>
                            <td class="bdTop_line" width="47" height="1"></td>
                    <td width="74" height="1" class="bdTop_line"></td>
                    <td width="443" height="1" class="bdTop_line"></td>
                    <td width="82" height="1" class="bdTop_line"></td>
                    <td width="82" height="1" class="bdTop_line"></td>
                    <td width="67" height="1" class="bdTop_line"></td>
                    <td width="57" height="1" class="bdTop_line"></td>
        </tr>
        <tr>
                            <td class="bdTop_shadow" width="47" height="2"></td>
                    <td width="74" height="2" class="bdTop_shadow"></td>
                    <td width="443" height="2" class="bdTop_shadow"></td>
                    <td width="82" height="2" class="bdTop_shadow"></td>
                    <td width="82" height="2" class="bdTop_shadow"></td>
                    <td width="67" height="2" class="bdTop_shadow"></td>
                    <td width="57" height="2" class="bdTop_shadow"></td>
        </tr> 
